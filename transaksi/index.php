...
$sql = "SELECT * FROM peminjaman INNER JOIN anggota ON peminjaman.id_anggota = anggota.id_anggota 
	INNER JOIN petugas ON peminjaman.id_petugas = petugas.id_petugas INNER JOIN detail_pinjam ON peminjaman.id_pinjam= detail_pinjam.id_pinjam ORDER BY peminjaman.tgl_pinjam ";
...
?>
		...
		<div class="card">
  			<div class="card-header">
  				<h2 class="card-title"><i class="fas fa-address-book"></i> Data Peminjaman</h2>
  			</div>
 	 <div class="card-body">
...
<div class="card">
  				<center><h4 class="card-title"><i class="fas fa-user-plus text-black mr-2"></i><a href="form-pinjam.php"> Tambah Peminjaman</h4></a></h4></center>
  			</div>
  </div>
</div>
